 ...
 * @author Asus
 */
public class RemovePatientFrame2 extends javax.swing.JFrame {

    /**
     * Creates new form RemovePatientFrame2
     */
    List<String>patIdList;
    public RemovePatientFrame2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jcPatId.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try{
            boolean result1=PatientDao.deletePatientById(patId);
            boolean result2=AppointmentDao.deleteAppointmentById(patId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemovePatientFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemovePatientFrame2().setVisible(true);
            }
        });
    }
