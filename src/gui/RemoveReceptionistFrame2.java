 ...
 * @author Asus
 */
public class RemoveReceptionistFrame2 extends javax.swing.JFrame {

    /**
     * Creates new form RemoveReceptionistFrame2
     */
    public RemoveReceptionistFrame2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jcRecId.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jcRecId, javax.swing.GroupLayout.PREFERRED_SIZE, 268, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        try{
            String name=ReceptionistDao.getRecName(recId);
            boolean result1=UserDao.deleteUserByName(name);
            boolean result=ReceptionistDao.deleteRecById(recId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveReceptionistFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveReceptionistFrame2().setVisible(true);
            }
        });
    }
    ...
    private void loadReceptionistId() {
        try{
            List<String > recList=ReceptionistDao.getAllRecId();
            for(String i:recList){
                jcRecId.addItem(i);
            }
            if(jcRecId.getItemCount()!=0){
