 ...
 * @author Asus
 */
public class ViewAllPatients2 extends javax.swing.JFrame {

    /**
     * Creates new form ViewAllPatients2
     */
    private DefaultTableModel model;
    public ViewAllPatients2() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllPatients2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllPatients2().setVisible(true);
            }
        });
    }
