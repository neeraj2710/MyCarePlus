 ...
 * @author Asus
 */
public class RegisterReceptionistFrame2 extends javax.swing.JFrame {

    /**
     * Creates new form REgisterReceptionistFrame2
     */
    private Map<String,String>unRegRecList;
    private String selEmpName,selEmpId,loginId;
    private String password,rePassword;
    public RegisterReceptionistFrame2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jcEmpId.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        txtReceptionistId.setBackground(new java.awt.Color(255, 255, 255));
        txtReceptionistId.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        txtReceptionistId.setForeground(new java.awt.Color(0, 0, 0));
        txtReceptionistId.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    ...
    private void btnRegActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegActionPerformed
        ...
        try{
            ...
            boolean result2=ReceptionistDao.addReceptionist(recep);
    ...
    private void jcEmpIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcEmpIdActionPerformed
        ...
        this.txtRecName.setText(selEmpName);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterReceptionistFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterReceptionistFrame2().setVisible(true);
            }
        });
    }
    ...
    private void getNewRecId() {
        try{
            ...
            this.txtReceptionistId.setText(recId);
        }catch(SQLException ex){
            JOptionPane.showMessageDialog(null,"Error in DB:"+ex.getMessage());
            ex.printStackTrace();
        }
