 ...
 * @author Asus
 */
public class ViewReceptionistFrame2 extends javax.swing.JFrame {

    /**
     * Creates new form ViewReceptionistFrame2
     */
    private DefaultTableModel model;
    public ViewReceptionistFrame2() {
        initComponents();
        lblName.setText(UserProfile.getUserName());
        model=(DefaultTableModel)jtRec.getModel();
        getAllRecDetails();
    ...
    private void initComponents() {
        ...
        jtRec.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jtRec);

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel6.setText("All Receptionist");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewReceptionistFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewReceptionistFrame2().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jtRec;
    private javax.swing.JLabel lblName;
    private javax.swing.JPanel panelBack;
    private javax.swing.JPanel panelLogout;
    // End of variables declaration//GEN-END:variables

    private void getAllRecDetails() {
        try{
