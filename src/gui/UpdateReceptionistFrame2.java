 ...
 * @author Asus
 */
public class UpdateReceptionistFrame2 extends javax.swing.JFrame {

    /**
     * Creates new form UpdateReceptionistFrame2
     */
    private String prvLoginId, loginId,password,rePassword,selEmpName;
    public UpdateReceptionistFrame2() {
        initComponents();
    ...
    private void panelBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelBackMouseClicked
        // TODO add your handling code here:
        ManageReceptionistFrame2 AOFrame = new ManageReceptionistFrame2();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try{
            ...
            boolean result2=ReceptionistDao.updateReceptionist(rec);
            if(result1==true && result2==true){
                JOptionPane.showMessageDialog(null,"Receptionist udated successfully!");
                
                return;
            }
            JOptionPane.showMessageDialog(null,"Receptionist updation unsuccessfull!");
    ...
    private void jcRecIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcRecIdActionPerformed
        // TODO add your handling code here:
        try{
            ReceptionistPojo rec=ReceptionistDao.getRecDetails(jcRecId.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateReceptionistFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateReceptionistFrame2().setVisible(true);
            }
        });
    }
